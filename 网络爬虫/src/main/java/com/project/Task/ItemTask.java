...
import com.project.Utile.Httputile;
...
public class ItemTask  {
    ...
    public void itemTask() throws Exception{
        String url = "https://search.jd.com/Search?keyword=%E6%89%8B%E6%9C%BA&enc" +
                "=utf-8&qrst=1&rt=1&stop=1&vt=2&cid2=653&cid3=655&s=5760&click=0&page=";
    ...
    public  void parseHtml(String html){
        ...
        for (Element spuEle : spus) {
            ...
            for (Element skuEle : skus) {
                ...
                //下载图片
                String picName = this.httpUtils.doGetImg(pic);
                item.setPic(picName);
